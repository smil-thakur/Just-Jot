...
const EditModal = ({ isOpen, onClose, color, handleEditNote, ptitle, pbody, timeStamp, index }) => {
    const modalStyles = {
        overlay: {
            position: 'fixed',
            top: 0,
            ...
            {isOpen && (
                <div style={modalStyles.content}>
                    ...
                    <div className={style} style={{ backgroundColor: color }}>
                        <div className="p-2">
                            ...
                            <div className="break-words h-20 md:h-52  overflow-scroll">
                                <textarea maxLength={200} onChange={handleBody} value={body} className="bg-transparent w-32 md:w-56 placeholder:text-black" placeholder="Jot Here" cols="40" rows="5"></textarea>
                    ...
                    <div className="flex justify-center m-5">
                        <button onClick={() => handleEditNote(index, title, body, timeStamp)} className="btn-class-name">
